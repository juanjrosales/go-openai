# Go OpenAI
[![Go Reference](https://pkg.go.dev/badge/github.com/juanjrosales/go-openai.svg)](https://pkg.go.dev/github.com/juanjrosales/go-openai)
[![Go Report Card](https://goreportcard.com/badge/github.com/juanjrosales/go-openai)](https://goreportcard.com/report/github.com/juanjrosales/go-openai)
[![codecov](https://codecov.io/gh/juanjrosales/go-openai/branch/master/graph/badge.svg?token=bCbIfHLIsW)](https://codecov.io/gh/juanjrosales/go-openai)
...
### Installation:
```
go get github.com/juanjrosales/go-openai
```
...
import (
	"context"
	"fmt"
	openai "github.com/juanjrosales/go-openai"
)
...
See also: https://pkg.go.dev/github.com/juanjrosales/go-openai#ClientConfig
</details>
...
import (
	...
	"github.com/juanjrosales/go-openai"
)
...
We want to take a moment to express our deepest gratitude to the [contributors](https://github.com/juanjrosales/go-openai/graphs/contributors) and sponsors of this project:
